export const Education = ({resultValue}) => {
        ...
        <>
         <form>
              ...
              <input type="text" onChange={resultValue} name='school' />
              <label htmlFor="degree"><h4>Degree</h4></label>
              <input type="text" onChange={resultValue} name='degree' />
              <label htmlFor="startDate" ><h4>Start Date</h4></label>
              <input type="date" onChange={resultValue} name='startDate'/>
              <label htmlFor="endDate" ><h4>End Date</h4></label>
              <input type="date" onChange={resultValue} name='endDate' />
              <label htmlFor="location" ><h4>Location</h4></label>
              <input type="text" onChange={resultValue} name='location'/>
...
export const Experience = ({resultValue}) => {
    ...
    return(
            ...
            <input type="text"  onChange={resultValue} name='companyName'/>
            <label htmlFor="positionTitle"  ><h4>Position Title</h4></label>
            <input type="text"onChange={resultValue} name='positionTitle'/>
            <label htmlFor="startDate" ><h4>Start Date</h4></label>
            <input type="date" onChange={resultValue} name='startDate'/>
            <label htmlFor="endDate" ><h4>End Date</h4></label>
            <input type="date" onChange={resultValue} name='endDate'/>
            ...
            <input type="text" onChange={resultValue} name='description'/>
            <button className='deleteButton'>Delete</button>
           </form>
           </>
           )
